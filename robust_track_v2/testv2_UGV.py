...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_name', default='/home/rislab/Workspace/pysot/testing_dataset/UGV/210118_1', type=str,
                        help='videos or image files')
    parser.add_argument('--save_path', default='', type=str,
                        help='')
    args = parser.parse_args()
    args.video_name='/home/rislab/Workspace/pysot/testing_dataset/OTB100/Girl2'
