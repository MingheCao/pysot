...
def main(dataset,video_name):
    ...
    ourpnp_rects=np.loadtxt('/home/rislab/Workspace/pysot/robust_track_v2/result/UGV/DaSiamRPN/' + video_name +'.txt',delimiter=',')
    ourpn_rects=np.loadtxt('/home/rislab/Workspace/pysot/robust_track_v2/result/UGV/Ours(SiamRPN)/' + video_name +'.txt',delimiter=',')
    rpnp_rects = np.loadtxt('/home/rislab/Workspace/pysot/robust_track_v2/result/UGV/SiamRPN++/' + video_name +'.txt',delimiter=',')
    rpn_rects = np.loadtxt('/home/rislab/Workspace/pysot/robust_track_v2/result/UGV/SiamRPN/' + video_name +'.txt',delimiter=',')
    da_rects = np.loadtxt('/home/rislab/Workspace/pysot/robust_track_v2/result/UGV/DaSiamRPN/' + video_name +'.txt',delimiter=',')
    update_rects = np.loadtxt('/home/rislab/Workspace/pysot/robust_track_v2/result/UGV/UpdateNet/' + video_name +'.txt',delimiter=',')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_name', default='210118_3', type=str,
